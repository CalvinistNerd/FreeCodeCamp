		...
		navigator.geolocation.getCurrentPosition(function(position) {
			...
			$.ajax({
				...
				success: function(parsed_json) {
					...
					day1Cond = parsed_json['forecast']['simpleforecast']['forecastday'][0]['conditions'];
					day2Cond = parsed_json['forecast']['simpleforecast']['forecastday'][1]['conditions'];
					day3Cond = parsed_json['forecast']['simpleforecast']['forecastday'][2]['conditions'];
					day4Cond = parsed_json['forecast']['simpleforecast']['forecastday'][3]['conditions'];
					day5Cond = parsed_json['forecast']['simpleforecast']['forecastday'][4]['conditions'];
					day6Cond = parsed_json['forecast']['simpleforecast']['forecastday'][5]['conditions'];

					$(".day-1-cond").html(day1Cond);
					$(".day-2-cond").html(day2Cond);
					$(".day-3-cond").html(day3Cond);
					$(".day-4-cond").html(day4Cond);
					$(".day-5-cond").html(day5Cond);
					$(".day-6-cond").html(day6Cond);
